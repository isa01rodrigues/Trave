...
<div> <!----link para uma nova pg-->
    ...
    <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);"
     href="index.php?p=cliente&c=cadastrar">
...
<thead >
        ...
        <tr>
            <th scope="table-success">idCliente</th>
...
<?php foreach ($lista as $linha) : ?>
            ...
            <td><?php echo $linha['senhaCliente'] ?></td>
            ...
            <td><?php echo $linha['statusCliente'] ?></td>
                ...
                <td> <a class="icon-link icon-link-hover" href="index.php?p=cliente&c=atualizar&id=<?php echo $linha['idCliente']?>" class="imgListar">
                    ...
                    <td> <a class="icon-link icon-link-hover" href="index.php?p=cliente&c=desativar&id=<?php echo $linha['idCliente']?>"  class="imgListar">

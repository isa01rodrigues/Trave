...
<div> <!----link para uma nova pg-->
    ...
    <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);"
     href="index.php?p=estoque&e=cadastrar">
...
<thead >
        ...
        <tr>
            <th scope="table-success">idEstoque</th>
...
<?php foreach ($lista as $linha) : ?>
            ...
            <td><?php echo $linha['tipoProduto'] ?></td>
            <td><?php echo $linha['configuracaoProduto'] ?></td>
            <td><?php echo $linha['quantidadeEstoque'] ?></td>
            <td><?php echo $linha['valorDiaria'] ?></td>
            <td><?php echo $linha['statusEstoque'] ?></td>
                ...
                <td> <a class="icon-link icon-link-hover" href="index.php?p=estoque&e=atualizar&id=<?php echo $linha['idEstoque']?>" class="imgListar">
                    ...
                    <td> <a class="icon-link icon-link-hover" href="index.php?p=estoque&e=desativar&id=<?php echo $linha['idEstoque']?>"  class="imgListar">

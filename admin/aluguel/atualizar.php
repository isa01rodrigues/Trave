...
$aluguel = new aluguelClass ($id); // Instantiate a cliente object
...
<section>
<form class="formulario-CAD" action="index.php?p=aluguel&a=atualizar$id=<?php echo $aluguel->idAluguel ?>" method="POST" enctype="multipart/form-data">

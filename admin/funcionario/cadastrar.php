...
if(isset ($_POST['nomeFuncionario'])){
    ...
    //Responsável por fazer o upload da imagem que está no diretório raiz para o banco de dados, onde caso não
    ...
    /***De onde vai vir as informações da classe***/
    require_once('class/Cfuncionario.php');

    
    //METODO RESPONSAVEL DE PASSAR AS INFORMAÇÕES DA CLASSE
...
?>
<!--Formulario para cadastro de um novo Funcionario-->
...
<section>
<form class="formulario-CAD" action="index.php?p=funcionario&i=cadastrar" method="POST" enctype="multipart/form-data">
    ...
    <div class="formulario-Cadastrar">
        ...
        <div class="senhaFuncionario">
            ...
            <input type="password" class="form" name="senhaFuncionario" id="senhaFuncionario" required placeholder="Infome a senha do funcionario">
        </div>

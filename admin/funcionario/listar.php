...
$funcionaros = new funcionarioClass();
...
<div> <!----link para uma nova pg-->
    ...
    <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);"
     href="index.php?p=funcionario&i=cadastrar">
...
<thead >
        ...
        <tr>
            <th scope="table-success">idFuncionario</th>
            <th scope="col">NOME</th>
            <th scope="col">TELEFONE</th>
            <th scope="col">E-MAIL</th>
            <th scope="col">SENHA</th>  
            <th scope="col">FUNÇÃO</th>
            <th scope="col">DATA ADMINSSÃO</th>
...
<?php foreach ($lista as $linha) : ?>
            ...
            <td><?php echo $linha['funcaoFuncionario'] ?></td>
            <td><?php echo $linha['dataAdminFuncionario'] ?></td>
            <td><?php echo $linha['statusFuncionario'] ?></td>
                ...
                <td> <a class="icon-link icon-link-hover" href="index.php?p=funcionario&i=atualizar&id=<?php echo $linha['idFuncionario']?>" class="imgListar">
                    ...
                    <td> <a class="icon-link icon-link-hover" href="index.php?p=funcionario&i=desativar&id=<?php echo $linha['idFuncionario']?>"  class="imgListar">
